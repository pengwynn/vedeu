    ...
    describe HTML do
      ...
      describe '#html_body' do
        ...
        context 'when there is content on the buffer' do
          context 'when the content is a Vedeu::Escape, then it cannot be ' \
                  'rendered as HTML and therefore discarded' do
            let(:buffer) { Vedeu::Escape.new(value: Vedeu::Esc.show_cursor) }
